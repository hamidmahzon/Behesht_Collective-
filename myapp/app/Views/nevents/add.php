...
?>
    ...
    <form class="w3-form w3-modal-content w3-animate-opacity" action="<?=base_url('add/nevents')?>" enctype="multipart/form-data" method="post" style="background: linear-gradient(<?=$gcolor?>)">
        <?= csrf_field() ?>
